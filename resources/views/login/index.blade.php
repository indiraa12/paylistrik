...
>
  <head>
    ...
    <title>Login Basic | Klikpay</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  <span class="app-brand-text demo text-body fw-bolder">Klikpay</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Login Klikpay! 👋</h4>
              ...
              <form class="mb-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('username')is-invalid @enderror" id="username" required name="username" placeholder="username" autofocus/>
                    @error('username')
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="password" id="password" class="form-control @error('password')is-invalid @enderror" name="password" required placeholder="Masukkan Password" aria-describedby="password"/>
