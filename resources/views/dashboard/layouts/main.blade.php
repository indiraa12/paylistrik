        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Dashboard -->
                    <li class="menu-item  {{ Request::is('dashboard') ? 'active' : '' }}" style="color:chocolate">
                        <a href="/dashboard" class="menu-link" style="color:black">
                    ...
                    @if (Auth::user()->role_id == 1)
                        ...
                        <li class="menu-item  {{ Request::is('admin/pelanggan*') ? 'active' : '' }}">
                            <a href="/admin/pelanggan" class="menu-link" style="color:black">
                        ...
                        <li class="menu-item  {{ Request::is('admin/penggunaan*') ? 'active' : '' }}">
                            <a href="/admin/penggunaan" class="menu-link" style="color:black">
                                <i class="menu-icon tf-icons bx bxs-user-detail"></i>
                                <div data-i18n="Data Penggunaan">Data Penggunaan</div>
                            </a>
                        </li>
                        ...
                        <li class="menu-item  {{ Request::is('admin/tarif*') ? 'active' : '' }}">
                            <a href="/admin/tarif" class="menu-link" style="color:black">
                                ...
                                <div data-i18n="Basic">Tarif Listrik</div>
                            </a>
                        </li>
                    @else
                        <!-- Components -->
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <input type="text" class="form-control border-0 shadow-none" placeholder="Hallo "
                                    aria-label="Search..." />
                            </div>
                        </div>
                        <!-- /Search -->
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                        ...
                                        <div class="avatar avatar-online">
                                            <img src="{{ asset('style/assets/img/avatars/ini.jpg') }}" alt
                                        ...
                                        <li>
                                            <form action="/logout" method="POST">
                                                ...
                                                <button type="submit" class="dropdown-item"><i
                                                        class="bx bx-power-off me-2"></i>logot
                                                </button>
                                            </form>
                                        </li>
                                    @endauth
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                Coppyright by Klikpay Indi Rahmadani
                            </div>
